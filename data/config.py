...
cfg_eca_cbam = {
    ...
    'performance_targets': {
        ...
        'total_parameters': 449000,        # ~449K achieved (better than 460K target)
    ...
    'validation_checks': {
        'parameter_count_target': 449000,        # ~449K achieved (better than 460K target)
    ...
    'cbam_comparison': {
        'parameter_efficiency': '8.1% reduction (449K vs 488.7K)',
